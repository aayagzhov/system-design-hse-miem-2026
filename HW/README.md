...
Здесь лежат **выполненные** решения по курсу «Системный дизайн».

## Файлы

| Файл | Тип | Статус | Сдача |
|------|-----|--------|-------|
...
Всё, что нужно сделать **лично на компе с Docker** — в файле [PRACTICE_INSTRUCTIONS.md](./PRACTICE_INSTRUCTIONS.md).
